...
public class DateUtils {
	...
	public final static String FORMAT_DD_MM_YY = "dd/MM/yy";
	...
	public static String getCurrentDateTime() {
	    Date now = new Date();
	    return getDateFormat(FORMAT_YYYY_MM_DD_HH_MI_SS).format(now);
	}
	...
	*/ 
	 ...
	 * @throws Exception
	 */
	 public static int calDiffMonth(Date edate, Date sdate){  
     ...
     * 获取指定日期的 年、月、日
     * @param date
     * @param numType Calendar.YEAR Calendar.MONTH Calendar.DAY_OF_MONTH;;
     * @return
     */
    public static int getDateField(Date date, int numType){
    	Calendar c = Calendar.getInstance();
    	c.setTime(date);
    	return c.get(numType);
    }
     ...
     * @return
     */
    public static int getDateField(long timeStamp, int numType){
    	Calendar c = Calendar.getInstance();
	...
	public static long getTimestampByYMD(int year, int month, int day) {
...
//		System.out.println(getPreviousOrNextMonthsOfDate(new Date(), 1));
		//;
	}
}
